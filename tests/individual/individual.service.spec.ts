...
describe("individual service file", () => {
    ...
    context("#createindividualAccount()", () => {
        it("should be a function", () => {
            expect(individualService.createIndividualAccount).to.be.a(
                "function"
            );
        });
        ...
        it("this function should create IIndividualAccountDto", async () => {
            ...
            sinon
                .stub(individualRepository, "createIndividualAccount")
                .resolves(individual_account);

            const created_account =
                await individualService.createIndividualAccount(
    ...
    context("#getindividualById()", () => {
        ...
        it("this function should get the IIndividualAccountDto", async () => {
            ...
            const individual_acount = await individualService.getIndividualById(
                1
            );
    ...
    context("#getindividuals()", () => {
        ...
        it("this function should get all the IIndividualAccountDto accounts", async () => {
            sinon
                .stub(individualRepository, "getIndividuals")
                .resolves([individual_account]);

            const individual_acounts = await individualService.getIndividuals([
                1,
            ]);
    ...
    context("#formatAccount()", () => {
        ...
        it("this function should return IIndividualAccountDto", () => {
            const individual =
                individualService.formatAccount(individual_account);
