...
import { ICreateIndividualDto, IIndividualAccountDto, IIndividualAccount } from "./individual.interface.js";
...
class IndividualService implements IAccountFormatter<IIndividualAccount, IIndividualAccountDto> {
    
    getIndividualById = async (individual_account_id: number) => {
        const individual : IIndividualAccount = await individualRepository.getIndividualById(individual_account_id);
    ...
    getIndividuals = async (individual_ids: number[]) => {
        const individuals = await individualRepository.getIndividuals(individual_ids);
    ...
    createIndividualAccount = async (create_individual_dto: ICreateIndividualDto) => {
    ...
    // email: string;
        ...
        const { individual_id, first_name, last_name, email } = create_individual_dto;
